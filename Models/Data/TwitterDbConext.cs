    ...
    public class TwitterDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>( entity => {
                ...
                .IsRequired()
                .HasMaxLength(300);
                entity.Property(u => u.FollowerCount).HasDefaultValue(0);
            ...
            modelBuilder.Entity<Follow> ( entity => {
                ...
                .WithMany( u => u.Followers ) // This specifies that the Following user can have many followers . The Followers collection in the User class will contain all the Follow objects where this user is the Following.
